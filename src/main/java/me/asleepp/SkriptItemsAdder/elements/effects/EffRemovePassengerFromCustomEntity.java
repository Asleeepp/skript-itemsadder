...
public class EffRemovePassengerFromCustomEntity extends Effect {

    private Expression<Entity> entities;
    private Expression<Entity> customEntityId;

    static {
        Skript.registerEffect(EffRemovePassengerFromCustomEntity.class, new String[] {"(eject|remove) %entities% from [passenger[s] of] (custom|ia|itemsadder) entity %entity%"});
    }
                ...
                if (customBukkitEntity instanceof LivingEntity) {
                    ...
                    for (Entity entity : entities) {
                        if (entity instanceof LivingEntity) {
                            customLivingEntity.removePassenger((LivingEntity) entity);
                        }
                    }
                }
            }
    ...
    public String toString(@Nullable Event e, boolean debug) {
        return "remove " + entities.toString(e, debug) + " from passengers of custom entity " + customEntityId.toString(e, debug);
    }
